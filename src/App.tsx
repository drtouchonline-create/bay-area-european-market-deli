  ...
  const plans = [
    {
      ...
      description: "I build an Express Pickup page for your 5 best-selling items. Customers order via WhatsApp. Zero cost, zero risk.",
      cost: '$0',
    ...
    },
    {
      ...
      description: "Complete digital presence: product catalog, Google review automation, stock alerts, and local SEO. Own Concord search.",
      cost: '$500',
    ...
    },
    {
      ...
      description: "I handle everything monthly: competitor analysis, social content, ads, and revenue reporting. You focus on the market.",
      cost: '$300',
